...
def setup_product():
    ...
    import custom.deleteuser
    zcml.load_config('configure.zcml', custom.deleteuser)
    ...
    ztc.installPackage('custom.deleteuser')
...
setup_product()
ptc.setupPloneSite(products=['custom.deleteuser'])
