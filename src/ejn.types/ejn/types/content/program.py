...
ProgramSchema = schemata.ATContentTypeSchema.copy() + atapi.Schema((
  ...
  atapi.TextField('text',
            ...
            widget=atapi.RichWidget(label="Program Narrative"),
            ),
   ...
   atapi.LinesField('program',
             vocabulary=ejn_programs,
             index='KeywordIndex',
             multiValued=True,
             widget=atapi.MultiSelectionWidget(label="Program",
                                  format='checkbox',
                                  description="",
                                  ),
             ),

  atapi.ReferenceField('people',
  ...
  atapi.ReferenceField('parentProgram',
