...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      template: "{text} <b>{user}</b> ({time})",  // [string or function] template used to construct each tweet <li> - see code for available vars
    ...
    function format_relative_time(time_ago) {
      ...
      if ( time_ago.hours > 24 )   return 'yesterday';
